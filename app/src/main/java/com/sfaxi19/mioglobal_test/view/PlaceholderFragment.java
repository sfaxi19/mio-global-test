...
public class PlaceholderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch(getArguments().getInt(ARG_SECTION_NUMBER)) {
            case 1:
                activity.settingsSection = new SettingsSection(activity,rootSettingsView);
                activity.settingsSection.view();
                return rootSettingsView;
            case 2:
                activity.mainSection = new MainSection(activity, rootView);
                activity.mainSection.view();
                return rootView;
            case 3:
                DiscoverSection discoverSection = new DiscoverSection(activity, rootView);
